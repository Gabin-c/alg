            ...
            if read2 != refer:
                if data_vcf.loc[data_vcf['POS'] == (valeur + pos_read)].empty is False:
                    ...
                    if data_vcf.loc[data_vcf['POS'] == (valeur + pos_read)]['ALT'].empty is True:
                        ...
                        if data_vcf['ABUNDANCE'][data_vcf['POS'] == (valeur + pos_read)][
                            data_vcf['ALT'] == read2].empty is False:
...
tps1 = time.time()
mapping('smallMappingTest/reference.fasta', 'dumped_index.dp', 'smallMappingTest/reads.fasta', 20, 5, 1, 'snps10.vcf')
mapping('coli/ecoli_sample.fasta', 'dumped_index3.dp', 'coli/ecoli_mutated_reads_1000.fasta', 20, 10, 0, 'snps12.vcf')
